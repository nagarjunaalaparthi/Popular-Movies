...
public class MovieDetailsActivity extends BaseActivity {
    ...
    private void initViews() {
        ...
        mMovieOriginalLanguage = (TextView) findViewById(R.id.original_language);
        mMovieVotes = (TextView) findViewById(R.id.no_of_votes);
        ...
        mMovieOriginalLanguage.setText(getString(R.string.original_language, new Locale(movie.getOriginalLanguage()).getDisplayLanguage(Locale.getDefault())));
        mMovieVotes.setText(getString(R.string.no_of_votes, String.valueOf(movie.getVoteCount())));
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (youTubeVideoId != null) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(YOUTUBE_URL + youTubeVideoId));
